 ...
 */
@ControllerAdvice(basePackages = "com.demo.recommendation.controller")
public class RecommendExceptionHandler {

    private static final Logger logger = LoggerFactory.getLogger(RecommendExceptionHandler.class);
    ...
    @ResponseBody
    public Mono<ResponseEntity<Map<String, Object>>> handleResourceNotFoundException(NotFoundException ex, ServerWebExchange exchange) {
